...
/* *INDENT-ON* */
{
    ...
    mctest_assert_str_eq (vpath3->str, data->expected_path);
...
/* *INDENT-ON* */
{
    ...
    mctest_assert_str_eq (vpath->str, data->expected_path);
...
/* *INDENT-ON* */
{
    ...
    mctest_assert_str_eq (cloned_vpath->str, data->expected_path);
